...
import { Attribute, Issuer, Revision } from "../generated/schema";
import { ROOT_TAO, TAO, TI } from "../src/constants";
import {
...
describe("Trusted Issuers Registry - entity assertions", () => {
  ...
  beforeAll(() => {
    ...
    const attribute = new Attribute(Bytes.fromHexString(rootTaoAttributeId));
    attribute.issuer = issuer.id;
    attribute.latestRevision = Bytes.fromHexString(rootTaoAttributeId);
    attribute.save();

    const revision = new Revision(Bytes.fromHexString(rootTaoAttributeId));
  ...
  test("Validate initial state", () => {
    ...
    assert.fieldEquals("Revision", rootTaoAttributeId, "tao", rootTao);
    assert.fieldEquals("Revision", rootTaoAttributeId, "rootTao", rootTao);
    assert.fieldEquals("Revision", rootTaoAttributeId, "body", "");
    assert.fieldEquals("Revision", rootTaoAttributeId, "timestamp", "1");
  ...
  test("Add a new issuer (TAO)", () => {
    ...
    assert.fieldEquals("Revision", taoAttributeId, "tao", rootTao);
    assert.fieldEquals("Revision", taoAttributeId, "rootTao", rootTao);
    assert.fieldEquals("Revision", taoAttributeId, "body", "");
    assert.fieldEquals(
      "Revision",
      taoAttributeId,
      "timestamp",
  ...
  test("Add a new issuer (TI) and register attribute", () => {
    ...
    assert.fieldEquals("Revision", tiAttributeId, "tao", tao);
    assert.fieldEquals("Revision", tiAttributeId, "rootTao", rootTao);
    assert.fieldEquals("Revision", tiAttributeId, "body", "");
    assert.fieldEquals(
      "Revision",
      tiAttributeId,
      "timestamp",
    ...
    assert.fieldEquals("Revision", tiRevisionId, "tao", tao);
    assert.fieldEquals("Revision", tiRevisionId, "rootTao", rootTao);
    assert.fieldEquals("Revision", tiRevisionId, "body", tiAttributeBody);
    assert.fieldEquals(
      "Revision",
      tiRevisionId,
      "timestamp",
