...
abstract contract AppDetailed is AppStorage, DependencyRegistries {
    ...
    function insertAppInfo(bytes32 applicationId, bytes memory info) external {
        requirePolicyOrAppAdmin("TAR:insertAppInfo", applicationId);
        AppStoreLib.Applications storage apps = appStorage();
    ...
    function deleteAppAdministrator(
        ...
        requirePolicyOrAppAdmin("TAR:deleteAppAdministrator", applicationId);
        AppStoreLib.Applications storage apps = appStorage();
    ...
    function insertAppAdministrator(
        ...
        requirePolicyOrAppAdmin("TAR:insertAppAdministrator", applicationId);
        AppStoreLib.Applications storage apps = appStorage();
    ...
    function updateAppPublicKey(
        ...
        requirePolicyOrAppAdmin("TAR:updateAppPublicKey", appId);

        return apps.updateAppPublicKey(publicKeyId, status);
    }
    ...
    function insertAppPublicKey(
        ...
        require(status != AppStoreLib.Status.undefined, "invalid status");
        requirePolicyOrAppAdmin("TAR:insertAppPublicKey", appId);
        AppStoreLib.Applications storage apps = appStorage();
        return apps.insertAppPublicKey(appId, publickey, status);
    }
