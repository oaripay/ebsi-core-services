...
contract AdministratorStorage is AttributeStorage {
    ...
    bytes32
        public constant TAR_ADMINISTRATOR_DIAMOND_STORAGE_POSITION = keccak256(
        "diamond.standard.tar.administrator.storage"
    );
    ...
    {
        bytes32 position = TAR_ADMINISTRATOR_DIAMOND_STORAGE_POSITION;
        assembly {
            ms.slot := position
        }
    }
