...
library AttributeStoreLib {
    struct AttributeMetadata {
        // For each Attribute version hash, this is an object that stores the DID
        // of his owner and the hash of the first version.
        string did; // DID of the attribute owner.
        bytes32 attributeId; // Unique attribute ID (hash of the first attribute version)
    }
    struct AttributeDetails {
        // For a particular Entity and a specific Attribute id, this is an object that
        // stores all the attributes versions and values.
        // For a particular Entity and a specific Attribute id, this is the ordered
        // list of the hashes of each attribute version.
    ...
    struct Entity {
        ...
        bytes32[] attributes;
        // For a particular Entity and a specific Attribute id, this is a collection
        // of all attribute version hashes and corresponding attribute JSON-LD value.
