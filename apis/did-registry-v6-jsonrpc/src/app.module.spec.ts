  ...
  describe("Generic tests", () => {
    ...
    describe("GET /liveness", () => {
      ...
      it("should return an error 406 if called with an unsupported 'Accept' header", async () => {
        ...
        expect(mockedLogger.error.mock.calls).toStrictEqual([
          [
            "Cannot GET /liveness with 'Accept' header 'application/xml'",
    ...
    describe("GET /readiness", () => {
      ...
      it('should log the request and response without response body when the log level is not "debug"', async () => {
        ...
        await request(app.getHttpServer()).get("/readiness");
        ...
        expect(mockedLogger.log).toHaveBeenNthCalledWith(
          calls - 1,
          {
            ...
            message: "Incoming request - GET - /readiness",
            method: "GET",
          },
          "LoggingInterceptor - GET - /readiness",
          "LoggingInterceptor",
        );
        ...
        expect(mockedLogger.log).toHaveBeenNthCalledWith(
          calls,
          {
            message: "Outgoing response - 200 - GET - /readiness",
          },
          "LoggingInterceptor - 200 - GET - /readiness",
          "LoggingInterceptor",
        );
