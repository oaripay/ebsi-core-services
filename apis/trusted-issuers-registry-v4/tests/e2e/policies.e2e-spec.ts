      ...
      expect(response.body).toStrictEqual(
        expect.objectContaining({
          self: expect.stringContaining(
            "/trusted-issuers-registry/v4/policies?page[after]=1&page[size]=10"
          ),
          ...
          links: expect.objectContaining({
            ...
            next: expect.stringContaining(
              "/trusted-issuers-registry/v4/policies?page[after]="
            ),
  ...
  describe("/policies/{policyId}/revisions", () => {
    it("should return a paginated list of revisions", async () => {
      ...
      expect(response.body).toStrictEqual(
        expect.objectContaining({
          self: expect.stringContaining(
            `/trusted-issuers-registry/v4/policies/${encodeURIComponent(
              policyId
