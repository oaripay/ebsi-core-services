...
- add timeout to http requests (#45) - EBSIINT-4529

### 🐛 Bug Fixes

- fix Fastify Helmet plugin import (#46) - EBSIINT-4529

## 2.0.0-rc.1 (2022-07-06)

### 🚀 Features

- show docker tag version info (#36) - EBSIINT-4366
...
- update Node.js to v16.14.2 (#19) - EBSIINT-3981

### 🚀 Features

- bump dependencies - EBSIINT-4235
- update libs, use Authorisation API v2 and Ledger API v3 (#18) - EBSIINT-4003
...
- bootstrap
- bootstrap Policies Registry API (#1) - EBSIINT-3565
- implement /jsonrpc "addPolicyConditions", "deletePolicyCondition", "activatePolicy", "deactivatePolicy" (#5) - EBSIINT-3644
- implement /jsonrpc "insertPolicy" and "updatePolicy" methods (#4) - EBSIINT-3503
- implement /policies endpoint (#2) - EBSIINT-3501
- implement GET /policies/{policyId} endpoint (#3) - EBSIINT-3502
- implement TPR updates (#12) - EBSIINT-3849
- log requests and responses (#7) - EBSIINT-3651
