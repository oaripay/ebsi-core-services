...
- accept only EBSI DIDs ([#130](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/130/overview)) - EBSIINT-4351 ([cc6db02](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/cc6db02c60bd7caf2435a399ac0d663d0bbd0c34))

### 🚀 Features

- show docker version tag info ([#131](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/131/overview)) - EBSIINT-4363 ([26b9594](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/26b95944c993239545d9f39507b4441dfd1a0454))
...
- add sendSignedTransaction alias ([#87](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/87/overview)) - EBSIINT-3474 ([aa892c6](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/aa892c6b1feef7dce70f2bab82e117a24318a9d1))

## [2.0.0-rc.6](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/compare/diff?targetBranch=refs%2Ftags%2Fv2.0.0-rc.5&sourceBranch=refs%2Ftags%2Fv2.0.0-rc.6&targetRepoId=248) (2021-11-22)

### 🚀 Features

- update Node.js to v16.13.0 ([#81](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/81/overview)) - EBSIINT-3496 ([651df02](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/651df02b3c4bb91805777ebd8c91b7937c36ab1a))

### 🐛 Bug Fixes

- lint ([04462d0](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/04462d0113e6860a88977144cbdcc698e129d3aa))
- skip audit vulnerabilities ([#85](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/85/overview)) - EBSIINT-3497 ([14c47ba](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/14c47bad0c18e9c2a46d0d03256c99dfe32d23a2))

## [2.0.0-rc.5](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/compare/diff?targetBranch=refs%2Ftags%2Fv2.0.0-rc.4&sourceBranch=refs%2Ftags%2Fv2.0.0-rc.5&targetRepoId=248) (2021-10-18)

### 🐛 Bug Fixes

- update Node.js version to v14.18.1 ([#78](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/78/overview)) - EBSIINT-3432 ([6f68816](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/6f6881624ed4cc35b4a917888b28683d6e6d2358))

## [2.0.0-rc.4](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/compare/diff?targetBranch=refs%2Ftags%2Fv2.0.0-rc.3&sourceBranch=refs%2Ftags%2Fv2.0.0-rc.4&targetRepoId=248) (2021-10-04)

### 🐛 Bug Fixes

- follow new EBSI DID specifications ([#72](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/72/overview)) - EBSIINT-3333 ([f087bc6](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/f087bc63bb17fc0045c18561e13197a3e7ba4396))

### 🚀 Features

- support DID JWT with publicKeyMultibase ([#75](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/75/overview)) - EBSIINT-3333 ([fb0a1a3](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/fb0a1a38f6247410dd88a0890690d7f32cca2819))
- validate DID in /administrators endpoints ([#74](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/74/overview)) - EBSIINT-3333 ([8cdc188](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/8cdc188d2e88956351c4f7d8494af3edd1aeaa8f))

## [2.0.0-rc.3](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/compare/diff?targetBranch=refs%2Ftags%2Fv2.0.0-rc.2&sourceBranch=refs%2Ftags%2Fv2.0.0-rc.3&targetRepoId=248) (2021-09-15)

### 🚀 Features

- connect to Besu using WebSocket instead of HTTPS ([#61](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/61/overview)) - EBSIINT-3134 ([7e2ff2d](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/7e2ff2dab0f02e3d17da5252ef321b3c5903d2d9))
- control access with admin attributes ([#70](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/70/overview)) - EBSIINT-3297 ([19c39bf](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/19c39bf98080748d4d1218aeb66018f60588cad2))

### 🐛 Bug Fixes

- test jenkins ([#63](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/63/overview)) - EBSIINT-3182 ([8c9a383](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/8c9a3834ded0b694c45e02855f08e68d75471f9f))
- update dependencies and upgrade Node.js to 14.17.2 ([#62](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/62/overview)) - EBSIINT-3174 ([dc2049b](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/dc2049b7aed9e7b5492442ebc7844587715b4cb8))
- update Node.js to v14.17.5 ([#67](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/67/overview)) - EBSIINT-3220 ([3df7af0](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/3df7af0a5b64f68642b6a8ee3213776323292d8e))
- upgrade Node.js to v14.17.4 ([#65](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/65/overview)) - EBSIINT-3206 ([3e766fb](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/3e766fb18ca037b249e94c032bc38fa6eaa74290))

## [2.0.0-rc.2](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/compare/diff?targetBranch=refs%2Ftags%2Fv2.0.0-rc.1&sourceBranch=refs%2Ftags%2Fv2.0.0-rc.2&targetRepoId=248) (2021-06-17)

### 🚀 Features

- /public-keys ([#56](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/56/overview)) - EBSIINT-2971 ([21ae20b](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/21ae20b5cc04326463afe3a25024c3915651c326))

## [2.0.0-rc.1](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/compare/diff?targetBranch=refs%2Ftags%2Fv2.0.0-rc.0&sourceBranch=refs%2Ftags%2Fv2.0.0-rc.1&targetRepoId=248) (2021-05-20)

### 🐛 Bug Fixes

- connect to the blockchain directly ([#49](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/49/overview)) - EBSIINT-2970 ([e6562ad](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/e6562ad05981abee034aadc581c2d756374b4385))
- fix e2e tests ([#51](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/51/overview)) - EBSIINT-2941 ([22fe380](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/22fe380643a7def76db7b40f2e774df894576c18))
- fix e2e tests ([#53](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/53/overview)) - EBSIINT-2941 ([ecfc81f](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/ecfc81f62f33542cd82f5e463df43fafc6855adb))

### 🚀 Features

- protect API with JWT Auth ([#50](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/50/overview)) - EBSIINT-2941 ([d88da12](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/d88da12cc6538f376d211c83b999e76aafb8b39c))
- support 'undefined' domain and status, and 'suspended' status ([#52](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/pull-requests/52/overview)) - EBSIINT-2977 ([d285c55](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-apps-registry-api/commits/d285c55298a2ad6cc0a8c9fbc87a45457d22641f))
