...
Notifications API is an EBSI core service that helps to send async or delayed notifications by addressing the DID of a natural person or a legal entity.
