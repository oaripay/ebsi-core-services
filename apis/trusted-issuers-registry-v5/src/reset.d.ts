...
//
// Errors:
// - ../../contracts/trusted-issuers-registry-v3/src/types/common.ts:7:18 - error TS2430: Interface 'TypedEvent<TArgsArray, TArgsObject>' incorrectly extends interface 'Event'.
