...
describe("TIR API v6 - Issuers (e2e)", () => {
  ...
  beforeAll(async () => {
    ...
    // Get 2 issuers DID
    const issuersResponse: SupertestIssuersResponse =
  ...
  describe("/issuers/{did}/attributes/{attributeId}/revisions", () => {
    ...
    it("should return revisions", async () => {
      ...
      const urlPath = `/trusted-issuers-registry/v6/issuers/${lastExistingIssuerDid}/attributes/${attributeId}/revisions`;
          ...
          items: expect.arrayContaining([
            expect.objectContaining({
              href: expect.stringContaining(
                `/trusted-issuers-registry/v6/issuers/${testIssuerWithProxyDid}/proxies/0x`,
              ),
