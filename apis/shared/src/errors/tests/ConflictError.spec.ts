...
import { ConflictError, ProblemDetailsError } from "../index.ts";

describe("error ConflictError", () => {
  ...
  it("should have 'Conflict' as default title", () => {
    expect.assertions(1);
  ...
  it("should have the correct properties", () => {
    ...
    expect(error.status).toStrictEqual(ConflictError.statusCode);
  ...
  it("should print the correct string", () => {
    ...
    expect(error.toString()).toBe(`${ConflictError.statusCode} - Test Error`);
  });
});
