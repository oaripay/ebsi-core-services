...
export class RequestTimeoutError extends ProblemDetailsError {
  static defaultTitle = "Request Timeout";
   ...
   */
  constructor(
    title: string = RequestTimeoutError.defaultTitle,
    options?: {
      detail?: string;
    ...
    super(RequestTimeoutError.statusCode, title, options);
