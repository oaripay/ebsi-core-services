...
You can now open http://localhost:3000/did-registry/v4/health. If everything's working correctly, then you should see `"status":"ok"`.
...
Check http://localhost:3000/did-registry/v4/health to see if it's working.
