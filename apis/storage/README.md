...
You must at least set `EBSI_ENV` to run the API. For e2e testing, you must also set `TEST_APP_NAME`, `TEST_APP_PRIVATE_KEY`, `TEST_APP_KID`, `TEST_CLIENT_DID` and `TEST_CLIENT_PRIVATE_KEY`.
