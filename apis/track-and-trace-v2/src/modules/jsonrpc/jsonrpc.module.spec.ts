...
describe("JsonRpc Module", () => {
  ...
  beforeAll(async () => {
    ...
    const creatorAccount = document.didEbsiCreator;
        ...
        switch (test) {
          case "authoriseDid": {
            ...
            testSetup.push({
              ...
              expectedErrorMessage: `Invalid 'params.0.authorisedDid': Identifier ${randomAuthorisedDid} not found | Registry used: https://api-test.ebsi.eu/did-registry/v6/identifiers`,
              accessToken: user.accessToken.tntAuthorise,
            });
