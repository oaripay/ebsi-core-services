import "@ebsiint-sc/track-and-trace-v2/dist/hardhat.d.ts";
...
import { didToHex, hexToDid } from "../../src/shared/utils.ts";
import { createDocument, createEvent, dummyData } from "./data.ts";
