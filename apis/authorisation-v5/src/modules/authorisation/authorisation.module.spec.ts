            ...
            it("should return an error if the conditions specific to the scope are not met", async () => {
              ...
              switch (customScope) {
                ...
                case DIDR_WRITE_SCOPE: {
                  ...
                  expectedErrorMessage = `Invalid Verifiable Presentation: VP JWT validation failed: Unable to resolve ${vpSigner.kid}. Error: notFound. Not Found | Registry used: ${domain}/did-registry/v6/identifiers`;
                  break;
                }
