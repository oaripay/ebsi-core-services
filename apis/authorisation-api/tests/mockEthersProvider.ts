...
export default (): ethers.providers.JsonRpcProvider => {
  return {
    getLogs: jest.fn((): Promise<ethers.providers.Log[]> => {
      return of([
        {
          blockNumber: 646595,
          blockHash:
    ...
    getBlock: jest.fn((): Promise<ethers.providers.Block> => {
      return of({
        transactions: [
          "0xb0fec9e4ba9958f3f42b78ec7076d6aa6991c98b31f7efcce5e1d9faa07b3e11",
        ],
        hash: "0x0e3912e112f9b1fbf496c375dbdcb7b5cbc139c39fed4c55f36dc6ed9cda02cb",
        parentHash:
