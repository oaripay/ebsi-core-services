...
export interface OPMetadata {
  ...
  /**
   * RECOMMENDED. URL of the OP's UserInfo Endpoint. This URL MUST use the `https` scheme and MAY
   * contain port, path, and query parameter components.
   */
  userinfo_endpoint?: string;

  /**
   * The URL of the pushed authorization request endpoint at which the client can post an
