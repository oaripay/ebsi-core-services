...
import type { Scope } from "../../src/modules/authorisation/authorisation.interfaces";
...
describe("Authorisation (e2e)", () => {
  ...
  describe("GET /presentation-definitions", () => {
    ...
    it("should return the expected presentation definition for the given scope", async () => {
      ...
      const expectedPresentationDefinitions: Record<Scope, unknown> = {
        openid: expect.objectContaining({
