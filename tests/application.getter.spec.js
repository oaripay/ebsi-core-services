...
describe("trusted application registry", () => {
  ...
  describe("getAppAdministratorIds", () => {
    ...
    it("should failed if appId is empty", async () => {
      expect.assertions(0);
      await expectRevert(
        implV0.getAppAdministratorIds.call(constants.ZERO_BYTES32, 1, 1, {
          from: acc1,
        }),
        "appId empty"
      );
  ...
  describe("getAppInfoByInfoId", () => {
    it("should revert for an empty infoId", async () => {
      expect.assertions(0);
      await expectRevert(
        implV0.getAppInfoByInfoId(constants.ZERO_BYTES32, {
          from: acc1,
        }),
        "infoId empty"
      );
  ...
  describe("getAppInfoIds", () => {
    ...
    it("should failed if appId is empty", async () => {
      expect.assertions(0);
      await expectRevert(
        implV0.getAppInfoIds.call(constants.ZERO_BYTES32, 1, 1, {
          from: acc1,
        }),
        "appId empty"
      );
  ...
  describe("getAppPublicKeyIds", () => {
    it("should failed if appid is empty", async () => {
      expect.assertions(0);
      await expectRevert(
        implV0.getAppPublicKeyIds.call(constants.ZERO_BYTES32, 1, 1, {
          from: acc1,
        }),
        "appId empty"
      );
  ...
  describe("getAppById", () => {
    it("should revert for an empty appId", async () => {
      expect.assertions(0);
      await expectRevert(
        implV0.getAppById(constants.ZERO_BYTES32, {
          from: acc1,
        }),
        "appId empty"
      );
  ...
  describe("getAppInfo", () => {
    it("should revert for an empty appId", async () => {
      expect.assertions(0);
      await expectRevert(
        implV0.getAppInfo(constants.ZERO_BYTES32, {
          from: acc1,
        }),
        "appId empty"
      );
  ...
  describe("getAppByPublicKeyId", () => {
    it("should revert for an empty pubKeyId", async () => {
      expect.assertions(0);
      await expectRevert(
        implV0.getAppByPublicKeyId(constants.ZERO_BYTES32, {
          from: acc1,
        }),
        "pubKeyId null"
      );
  ...
  describe("getPublicKey", () => {
    it("should revert for an empty pubKeyId", async () => {
      expect.assertions(0);
      await expectRevert(
        implV0.getPublicKey(constants.ZERO_BYTES32, {
          from: acc1,
        }),
        "pubKeyId null"
      );
