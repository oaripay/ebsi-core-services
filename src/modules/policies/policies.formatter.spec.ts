...
describe("formatPolicies", () => {
  ...
  } as AsyncReturnType<SchemaSCRegistry["getPolicies"]>;
    ...
    items: [
      {
        ...
        hash:
          "0x18e1fa7cff7dd3862d81dae46f460ec063263913659be774dfc81fd4898db8d8",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0x40571838c18b0e83db06d167211279b437e0becc999309be2de54ccc7b8d096e",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0x2153bbe9b2d431b353277fcb266c75217445ee308cd046ce44493624394f9f47",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0xa0bed82e0b686622d123b90ee2eeead3ce1b7ce93006707790172646c8df4023",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0x4aaa1ada837395517b2727cb75535a542ba7bed77cce92ae36e6e258e867632e",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0x9855fd54b8ad2924b9e080d9c1c3b5fb7de8fe37a5053859d05012e5af0595ed",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0x99f5e8eb1136b916f816af314bd2e4563f3b03c41cd94cba47d9aca1f847fec4",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0xd875c68386da3171435c0192fbd3b0d1459b66fbdbbaf5e79d1aa14e297cbc66",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0x3e8ebeb70328599f5e7f142b4bfcb65e6ebc1c0a65df3f16474ab26ee0f965b3",
      },
      {
        policyId: "policy-test-b83c60f6247f964219bae755be62be8f",
        policy:
        ...
        hash:
          "0x3784f4c6e82fd710b5916319a8fac445c4a2be9fa11385946510e467ee945de6",
      },
    ],
    total: 12,
  };
