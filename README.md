...
- [Smart Contract Repository](https://ec.europa.eu/digital-building-blocks/code/projects/EBSI/repos/trusted-schemas-registry-ethereum-sc/browse)
...
You can now open http://localhost:3000/trusted-schemas-registry/v1/health. If everything's working correctly, then you should see `"status":"ok"`.
...
Check http://localhost:3000/trusted-schemas-registry/v1/health to see if it's working.
